...
# ══ 9. 남긴 것 ════════════════════════════════════════════════════════
s = d.add()
s.header("07", "이번 주가 남긴 것", "«했다»가 아니라 «남아 있다»로 세었다")

BIG = [("13", "docs/figures",
        "아키텍처 도식이 이번에 들어와 열세 장이 됐다. 그 전에는 저장소에 도식이 아예 없었다."),
       ("66", "한 번에 세운 리소스",
        "VPC · ALB · Fargate 2대 · RDS 까지 한 번에 서고, 확인 뒤 전부 내려갔다."),
       ("10", "workflow.md 규칙",
        "«확인 건수가 0이면 실패다»가 열 번째다. 세 번 같은 형태로 당하고 규칙이 됐다."),
       ("5", "닫은 이슈",
        "#42 배포 · #212 안전장치 · #214 도식 · #217 자료 원본 · #222 검증."),
       ("0", "내 담당 열린 이슈",
