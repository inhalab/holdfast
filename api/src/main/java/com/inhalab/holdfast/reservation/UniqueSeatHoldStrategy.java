 ...
 * 테이블이 아니라 <b>앱 레벨에서 무엇을 하느냐</b>다(2.2) — {@code seat_hold}는
 * <b>5개 전략 공통</b>이고 {@code none}까지 같은 테이블에 INSERT한다. 앱 락을
 * 쓰는 셋은 그 전에 각자의 락을 잡고, <b>이 전략은 그 단계가 비어 있으며</b>,
 * {@code none}은 그 단계도 U-2도 없다.
 *
